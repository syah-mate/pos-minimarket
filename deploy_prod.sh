...
REMOTE_HOST="lentera@web-01.lenterasolusi.id"
REMOTE_DIR="/home/lentera/projects/pos-minimarket"
echo "    Upload:  scp dist/pos-minimarket-standalone-${VERSION}.tar.gz ${REMOTE_HOST}:${REMOTE_DIR}/"
echo "    Extract: cd ${REMOTE_DIR} && tar -xzf pos-minimarket-standalone-${VERSION}.tar.gz --strip-components=1"
echo "    Run:     cd ${REMOTE_DIR} && PORT=$PORT ./run.sh"
